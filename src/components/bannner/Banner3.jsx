    ...
    <div className="banner-area3">
      ...
      <div className="social-area">
        <ul>
          ...
          <li>
            <a href="https://www.instagram.com/bigminds.tech" target="_blank">
      ...
      <Swiper {...slider} className="swiper banner3-slider">
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <div className="banner-wrapper">
              <div className="banner-content">
                <h1>Transforme seu Negócio com a Tecnologia</h1>
                <p>
                  Otimize processos e impulsione o crescimento com soluções
          ...
          <SwiperSlide className="swiper-slide">
            <div className="banner-wrapper">
              <div className="banner-content">
                ...
                <p>
                  Descubra como a tecnologia pode revolucionar seu modelo de
                  negócios.
                </p>
          ...
          <SwiperSlide className="swiper-slide">
            <div className="banner-wrapper">
              <div className="banner-content">
                <h1>Inovação e Desenvolvimento de Software</h1>
                <p>
                  Crie aplicativos e sistemas sob medida para suas necessidades.
                </p>
                <div className="banner-btn-group">
                  <Link legacyBehavior href="/contact">
                    <a className="primary-btn3">Fale Conosco</a>
