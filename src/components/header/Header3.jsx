    ...
    <>
      ...
      >
        ...
        <div className="sidebar-content">
          <p>Transformamos Ideias em Inovação.</p>
        </div>
        ...
        <div className="follow-area">
          <h5 className="blog-widget-title">Siga nossas Redes Sociais</h5>
        ...
        >
          ...
          <ul className="menu-list">
            ...
            >
              ...
              >
                <li>
                  <Link legacyBehavior href="/desenvolvimento-web-e-mobile">
                    <a
                      className={
                        currentRoute === "/desenvolvimento-web-e-mobile"
                          ? "active"
                          : ""
                      }
                    >
                ...
                <li>
                  <Link legacyBehavior href="/solucoes-cloud">
                    <a
                      className={
                        currentRoute === "/solucoes-cloud" ? "active" : ""
                      }
                    >
                      Soluções Cloud
                    </a>
                ...
                <li>
                  <Link legacyBehavior href="/solucao-de-pagamento-via-qrcode">
                    <a
                      className={
                        currentRoute === "/solucao-de-pagamento-via-qrcode"
                          ? "active"
                          : ""
                      }
                    >
                ...
                <li>
                  <Link
                    legacyBehavior
                    href="/solucao-integrada-de-gestao-de-dados"
                  >
                    <a
                      className={
                        currentRoute === "/solucao-integrada-de-gestao-de-dados"
                          ? "active"
                          : ""
                      }
                    >
                ...
                <li>
                  <Link legacyBehavior href="/desenvolvimento-de-software">
                    <a
                      className={
                        currentRoute === "/desenvolvimento-de-software"
                          ? "active"
                          : ""
                      }
                    >
                ...
                <li>
                  <Link legacyBehavior href="/automacao-de-processos">
                    <a
                      className={
                        currentRoute === "/automacao-de-processos"
                          ? "active"
                          : ""
                      }
                    >
                ...
                <li>
                  <Link legacyBehavior href="/ux-ui">
                    <a className={currentRoute === "/ux-ui" ? "active" : ""}>
                      UX/UI
                    </a>
                  </Link>
                </li>
          ...
          <div className="d-lg-none d-block">
            <form className="mobile-menu-form">
              <div className="hotline pt-30">
                ...
                <div className="hotline-info">
                  ...
                  <h6>
                    <a href="tel:+5534972331450">+55 (34) 97233-1450</a>
                  </h6>
                </div>
              </div>
            ...
            <div className="header-btn5">
              <Link legacyBehavior href="/contact">
                <a className="primary-btn3">Fazer Orçamento</a>
              </Link>
            </div>
          </div>
        </div>
