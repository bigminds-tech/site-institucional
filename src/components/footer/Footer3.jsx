      ...
      <div className="container">
        <div className="row g-lg-4 gy-5">
          <div className="row footer-widget">
            <div className="col-lg-4 footer-contact mb-40">
              <h4>
                <svg
                  width={14}
                  height={20}
              ...
              <a href="#">
                Av. Engenheiro Luís Carlos Berrini, 1681 - Cidade Monções, São
                Paulo - SP, 04571-011
              </a>
            </div>
            <div className="col-lg-4 footer-contact mb-40">
              ...
              <a href="mailto:contato@bigminds.tech">contato@bigminds.tech</a>
            </div>
                ...
                <ul>
                  <li>
                    <Link legacyBehavior href="/desenvolvimento-web-e-mobile">
                      <a>Desenvolvimento Web & Mobile</a>
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link
                      legacyBehavior
                      href="/solucao-de-pagamento-via-qrcode"
                    >
                      <a>Solução de Pagamento via QR Code</a>
                    </Link>
                  </li>
                  <li>
                    <Link
                      legacyBehavior
                      href="/solucao-de-integrada-gestao-de-dados"
                    >
                      <a>Solução Integrada de Gestão de Dados</a>
                    </Link>
                  </li>
                  <li>
                    <Link legacyBehavior href="/desenvolvimento-de-software">
                      <a>Desenvolvimento de Software</a>
                    </Link>
                  </li>
                  <li>
                    <Link legacyBehavior href="/automacao-de-processos">
                      <a>Automação de Processos</a>
                    </Link>
                  </li>
                  <li>
