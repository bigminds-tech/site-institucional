            ...
            <div className="row gy-5">
              ...
              >
                <div className="about-content">
                  ...
                  <p>
                    Oferecemos soluções de automação de processos que aumentam a
                    eficiência e reduzem custos operacionais. Nossa abordagem
                    personalizada ajuda empresas de todos os tamanhos a otimizar
                    suas operações diárias, permitindo que você concentre seus
                    esforços no crescimento do seu negócio.
                  </p>
                  <ul className="about-featue">
                    ...
                    <li>
                      ...
                      Automação de Vendas, Finanças e Contabilidade
                    </li>
                    <li>
                      <svg
                        width={9}
              ...
              >
                <div className="service-img magnetic-item">
                  <img
                    className="img-fluid"
                    src="assets/img/inner-pages/about-service-img-04.png"
                    alt=""
                  />
                </div>
              </div>
            ...
            <div className="row">
              ...
              >
                <div className="driscription-img magnetic-item">
                  <img
                    className="img-fluid"
                    src="assets/img/inner-pages/service-driscription-img-4.png"
                    alt=""
                  />
                </div>
              </div>
