            ...
            <div className="row gy-5">
              ...
              >
                <div className="about-content">
                  ...
                  <p>
                    Nosso serviço de Desenvolvimento Web & Mobile proporciona
                    soluções personalizadas para a criação de sites e aplicações
                    que atendem às suas necessidades específicas. Utilizamos as
                    mais recentes tecnologias para garantir que sua presença
                    online seja não apenas visualmente atraente, mas também
                    funcional e responsiva em todos os dispositivos, melhorando
              ...
              >
                <div className="service-img magnetic-item">
                  <img
                    className="img-fluid"
                    src="assets/img/inner-pages/about-service-img-01.png"
                    alt=""
                  />
                </div>
              </div>
