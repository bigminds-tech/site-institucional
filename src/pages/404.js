          ...
          <div className="row">
            <div className="col-lg-7 d-flex align-items-center">
              <div className="error-content">
                ...
                <p>
                  Ops!. Parece que a página que você está procurando na BigMinds
                  Tech se perdeu em algum lugar no caminho. Não se preocupe,
                  isso acontece! <br />
                  <br />
                  Agradecemos por sua visita e esperamos que você encontre o que
                  precisa em breve!
                </p>
            ...
            <div className="col-lg-5">
              <div className="error-img">
                <img
                  className="img-fluid"
                  src="assets/img/inner-pages/error-img.png"
                  alt=""
                />
              </div>
            </div>
